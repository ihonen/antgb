...
const uint8_t& CpuRegisters::get_B()
{
    return B;
}
...
const uint8_t& CpuRegisters::get_C()
{
    return C;
}
...
const uint8_t& CpuRegisters::get_D()
{
    return D;
}
...
const uint8_t& CpuRegisters::get_E()
{
    return E;
}
...
const uint8_t& CpuRegisters::get_H()
{
    return H;
}
...
const uint8_t& CpuRegisters::get_L()
{
    return L;
}
...
const uint8_t& CpuRegisters::get_A()
{
    return A;
}
...
const uint8_t& CpuRegisters::get_F()
{
    return F;
}
...
const uint16_t& CpuRegisters::get_BC()
{
    return BC;
}
...
const uint16_t& CpuRegisters::get_DE()
{
    return DE;
}
...
const uint16_t& CpuRegisters::get_HL()
{
    return HL;
}
...
const uint16_t& CpuRegisters::get_AF()
{
    return AF;
}
...
const uint16_t& CpuRegisters::get_PC()
{
    return PC;
}
...
const uint16_t& CpuRegisters::get_SP()
{
    return SP;
}
...
const uint8_t& CpuRegisters::get_IE()
{
    return IE;
}
...
const uint8_t& CpuRegisters::get_IF()
{
    return IF;
}
...
const uint8_t& CpuRegisters::get_IME()
{
    return IME;
}

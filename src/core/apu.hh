...
public:
    ...
    struct Registers
    {
        ...
        uint8_t wave_pattern_ram1;
        uint8_t wave_pattern_ram2;
        uint8_t wave_pattern_ram3;
        uint8_t wave_pattern_ram4;
        uint8_t wave_pattern_ram5;
        uint8_t wave_pattern_ram6;
        uint8_t wave_pattern_ram7;
        uint8_t wave_pattern_ram8;
        uint8_t wave_pattern_ram9;
        uint8_t wave_pattern_ram10;
        uint8_t wave_pattern_ram11;
        uint8_t wave_pattern_ram12;
        uint8_t wave_pattern_ram13;
        uint8_t wave_pattern_ram14;
        uint8_t wave_pattern_ram15;
        uint8_t wave_pattern_ram16;
    };
};

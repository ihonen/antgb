...
ANTDBG_ALWAYS_INLINE uint16_t Emulator::read(regid_t register_id)
{
    ...
    switch (register_id)
    {
    case RegA: return cpu->A;
    case RegF: return cpu->F;
    case RegAF: return cpu->AF;
    case RegB: return cpu->B;
    case RegC: return cpu->C;
    case RegBC: return cpu->BC;
    case RegD: return cpu->D;
    case RegE: return cpu->E;
    case RegDE: return cpu->DE;
    case RegH: return cpu->H;
    case RegL: return cpu->L;
    case RegHL: return cpu->HL;
    case RegPC: return cpu->PC;
    case RegSP: return cpu->SP;
    case RegIME: return cpu->IME;
    default:
...
ANTDBG_ALWAYS_INLINE void Emulator::write(regid_t register_id, uint16_t value)
{
    if (register_id <= 0xFFFF)
    {
        mem->write(static_cast<addr_t>(register_id),
    ...
    switch (register_id)
    {
    case RegA: cpu->A = static_cast<uint8_t>(value); break;
    case RegF:
        // Only the bottom 4 bits of F are writable.
        cpu->F |= (0x0F) & static_cast<uint8_t>(value);
        break;
    case RegAF: cpu->AF = value; break;
    case RegB: cpu->B = static_cast<uint8_t>(value); break;
    case RegC: cpu->C = static_cast<uint8_t>(value); break;
    case RegBC: cpu->BC = value; break;
    case RegD: cpu->D = static_cast<uint8_t>(value); break;
    case RegE: cpu->E = static_cast<uint8_t>(value); break;
    case RegDE: cpu->DE = value; break;
    case RegH: cpu->H = static_cast<uint8_t>(value); break;
    case RegL: cpu->L = static_cast<uint8_t>(value); break;
    case RegHL: cpu->HL = value; break;
    case RegPC: cpu->PC = value; break;
    case RegSP: cpu->SP = value; break;
    case RegIME: cpu->IME = (value != 0) ? 1 : 0; break;
    default:
        cerr << std::hex << register_id << endl;
        assert(false);
        break;

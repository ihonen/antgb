...
{
public:
    Renderer(Mmu* mem, iRenderer* renderer);
...
private:
    ...
    iRenderer* gui_renderer;

    Mmu*       mem;
    framebuf_t frame_buffer;
...
Renderer::Renderer(Mmu* memory, iRenderer* renderer_)
...
{
    memset(frame_buffer.data(), 0x00, 160 * 144);
}

void Renderer::set_renderer(iRenderer* renderer)
{
...
Ppu::Ppu(Mmu* mmu_, Registers* reg, Cpu* cpu, iRenderer* renderer_)
...
void Ppu::set_renderer(iRenderer* renderer_)
{

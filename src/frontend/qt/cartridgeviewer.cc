...
{
    Cartridge* cart = debugger->emu->cartridge;
...
void CartridgeViewer::on_debugging_resumed()
{

}

void CartridgeViewer::on_debugging_paused()
{

}

void CartridgeViewer::on_breakpoint_added(uint16_t address)
{

}

void CartridgeViewer::on_breakpoint_removed(uint16_t address)
{

}

void CartridgeViewer::on_data_breakpoint_added(uint16_t address)
{

}

void CartridgeViewer::on_data_breakpoint_removed(uint16_t address)
{

}

void CartridgeViewer::on_memory_changed(uint16_t address)
{

}

void CartridgeViewer::on_rom_loaded()
{
    update_fields();
}

void CartridgeViewer::on_special_register_changed()
{

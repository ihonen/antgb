...
QPixmap* Pixmaps::DATA_BREAKPOINT2 = nullptr;
QPixmap* Pixmaps::DATA_BREAKPOINT2_HOVER = nullptr;
QPixmap* Pixmaps::DATA_BREAKPOINT2_PRESS = nullptr;
...
void Pixmaps::load_all()
{
    ...
    DATA_BREAKPOINT2 = new QPixmap(":/img/data_breakpoint2.png");
}
